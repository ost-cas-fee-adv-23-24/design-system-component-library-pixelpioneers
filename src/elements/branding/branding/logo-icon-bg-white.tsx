...
export const LogoIconBackgroundWhite: FC<BrandingProps> = ({ title, sizeWidth, sizeHeight }) => (
    <svg
        width={sizeWidth}
        height={sizeHeight}
        viewBox="0 0 160 160"
