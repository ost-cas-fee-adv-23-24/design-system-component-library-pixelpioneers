...
export const LogoMumbleHorizontal: FC<BrandingProps> = ({
    title,
    sizeHeight,
    sizeWidth,
    iconClasses,
    ...
    >
        ...
        <path
            ...
            fill="url(#paint4_linear_447_517)"
        />
        <path
        ...
        <defs>
            ...
            >
                ...
                <stop offset="1" stop-color={offsetStopColor} />
            </linearGradient>
            <linearGradient
                id="paint1_linear_447_517"
                x1="88"
                y1="32"
                x2="334.402"
                y2="32"
